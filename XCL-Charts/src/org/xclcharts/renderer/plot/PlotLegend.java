...
public class PlotLegend {
	...
	// 图例方向
	/*
	 * private XEnum.LegendType mLegendType = XEnum.LegendType.COLUMN; private
	 * XEnum.HorizontalAlign mHorizontalAlign = XEnum.HorizontalAlign.RIGHT;
