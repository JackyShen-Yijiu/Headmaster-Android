		...
		if (commentcount != null) {
			...
			if (sum == 0) {
				...
				LogUtil.print("总评论---" + (commentcount.goodcommnent)
						/ (sum * 1.0f) * 100);
				chartData.add(new PieData(null, good + "%", good, Color.rgb(123,
						214, 92)));
				chartData.add(new PieData(null, bad + "%", bad, Color.rgb(232,
						0, 49)));
				chartData.add(new PieData(null, general + "%", general, Color
						.rgb(61, 139, 255)));
			}
		}
