...
public class MailFragment extends BasePagerFragment implements OnItemClickListener, OnClickListener{
	...
	public View initView() {
		...
		unreadNoticeNumTv = (TextView) headerView.findViewById(R.id.tv_mail_school_announcement_num);
		SelectableRoundedImageView noticeIv = (SelectableRoundedImageView) headerView.findViewById(R.id.iv_mail_announcement);
	...
	private void loadUnreadNotice(){
		type = 2;
		//最后一个公告的sqlindexid
		int sqlindexid = SharedPreferencesUtil.getInt(mContext, UNREADNOTICECOUNT, 0);
