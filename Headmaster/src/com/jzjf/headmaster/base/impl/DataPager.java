...
import com.jzjf.headmaster.AssessActivity;
import com.jzjf.headmaster.MainActivity;
import com.jzjf.headmaster.PassPercentageAct;
import com.jzjf.headmaster.StatisticsAct;
...
import com.jzjf.headmaster.event.ComplaintEvent;
...
public class DataPager extends BasePagerFragment implements OnClickListener {
	...
	private int searchtype = 1;// 查询类型 查询时间类型：1 今天 2 昨天 3 一周 4 本月5本年
...
//	}
	...
	private void setSchoolStudentCount(
			List<com.jzjf.headmaster.bean.MainPageDataV2Bean.Schoolstudentcount> schoolstudentcount) {
...
//		String url = "statistics/getmainpagedatav2?userid=" + userId
//				+ "&searchtype=" + searchtype + "&schoolid=" + schoolId;
		
		ApiHttpClient.get(ApiHttpClient.MAIN_DATA, handler);
		
//		LogUtil.print("loadNetworkData url = " + url);
	}
	...
	public void onClick(View v) {
		...
		case R.id.data_star_3:
			...
			intent4.putExtra("commentlevel", 1);
