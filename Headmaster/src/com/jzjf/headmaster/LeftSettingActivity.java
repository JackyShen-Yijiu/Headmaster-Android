...
import com.jzjf.headmaster.bean.DataBean;
import com.jzjf.headmaster.cache.DataCleanManager;
...
//              ToastHelper.getInstance(CarCoachApplication.getInstance()).toast(R.string.clean_ok);
	...
	public void exit() {
		try {
			...
			SharedPreferencesUtil.putString(this, Config.LAST_LOGIN_PASSWORD, null);
...
//				params.put("userid", HeadmasterApplication.app.userInfo.userid);
				ApiHttpClient.post(ApiHttpClient.MESSAGE_REMIND, params, handler);
			}
		});
