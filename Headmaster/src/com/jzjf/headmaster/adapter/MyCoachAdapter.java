...
import com.jzjf.headmaster.bean.Subject;
...
//		}
		...
		mHolder.learn_progress.setText("已过：" + coachBean.passcount + "人");
		mHolder.learn_state.setText("在学：" + coachBean.learncount + "人");
		// 休息
...
//		}
		...
		Subject[] subjectList = coachBean.subject;
		String kemuStr = coachBean.carmodel + " ";
		for (int i = 0; i < subjectList.length; i++) {
			kemuStr = kemuStr + subjectList[i].name + " ";
		}
		mHolder.learn_kemu.setText(kemuStr);
