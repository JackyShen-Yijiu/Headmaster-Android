...
import com.jzjf.headmaster.BulletinHistoryActivity;
import com.jzjf.headmaster.CoachFeedbackDetailActivity;
import com.jzjf.headmaster.adapter.CoachFeedbackAdapter;
...
//				+ "&index=" + index + "&count=10", handler);
		ApiHttpClient.get(ApiHttpClient.COACH_FEEDBACK + "?index=" + index
				+ "&count=10", handler);
	}
	...
	private void loadUnreadNotice() {
		...
		ApiHttpClient.get(ApiHttpClient.BULLETIN_COUNT + "?seqindex=" + sqlindexid, handler);
