...
import com.sft.model.HXNotifier;
...
public class DemoHXSDKHelper extends HXSDKHelper {
	...
	private static DemoHXSDKHelper helper;

	public static DemoHXSDKHelper getInstance() {
		if (helper == null) {
			synchronized (DemoHXSDKHelper.class) {
				if (helper == null) {
					helper = new DemoHXSDKHelper();
				}
			}
		}
		return helper;
