...
public class ArcProgress extends View {
	...
	private final int default_unfinished_color = Color.rgb(3, 3, 3);
	...
	private boolean arcIsDisplayText;
	...
	protected void initByAttributes(TypedArray attributes) {
		...
		arcAngle = attributes.getFloat(R.styleable.ArcProgress_arc_angle,
				default_arc_angle);
		arcIsDisplayText = attributes.getBoolean(
				R.styleable.ArcProgress_arc_is_display_text, false);
